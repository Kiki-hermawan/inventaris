    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><?= $row['satnama'] ?></td>
                <td>
                    <button type="button" class="btn btn-info btn-sm" title="edit data" onclick="edit('<?= $row['satid'] ?>')">
                        <i class="fa fa-edit"></i>
                    </button>

                    <button type="button" class="btn btn-danger btn-sm" title="hapus data" onclick="hapus('<?= $row['satid'] ?>')">
